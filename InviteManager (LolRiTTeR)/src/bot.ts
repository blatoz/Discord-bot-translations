...
const main = async () => {
	...
	console.log(
		chalk.green(
			`Ez a ${chalk.blue(`${shardId}/${shardCount}`)} / ${chalk.blue(type)} példa ${chalk.blue(instance)}`
		)
	);
	console.log(chalk.green('-------------------------------------'));
	...
	console.log(chalk.green('-------------------------------------'));
	console.log(chalk.green('Bot indítása...'));
	console.log(chalk.green('-------------------------------------'));

	await client.init();

	console.log(chalk.green('-------------------------------------'));
	console.log(chalk.green('Várakozás a indítási jegyzetre...'));
	console.log(chalk.green('-------------------------------------'));

	await client.waitForStartupTicket();

	console.log(chalk.green('-------------------------------------'));
	console.log(chalk.green('Csatlakozás a Discordhoz...'));
	console.log(chalk.green('-------------------------------------'));
