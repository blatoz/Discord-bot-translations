...
export enum GuildPermission {
	...
	READ_MESSAGES = 'csatorna megtekintése',
	...
	VIEW_AUDIT_LOGS = 'vizsgálati log megtekintése',
	MANAGE_ROLES = 'rangi kezelése',
	CREATE_INSTANT_INVITE = 'gyors hivatkozás létrehozása',
	BAN_MEMBERS = 'tagok bannolása',
	KICK_MEMBERS = 'tagok kicsit kísérletezni',
	ADD_REACTIONS = ' reakciók hozzáadása',
	MANAGE_EMOJIS = 'emoji kezelése',
	READ_MESSAGE_HISTORY = 'üzenet előzményének olvasása'
}
