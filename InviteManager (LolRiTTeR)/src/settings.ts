...
export const guildSettingsInfo: {
	...
	joinMessage: {
		...
		defaultValue: '{memberMention} **csatlakozott**; Meghívta **{inviterName}** (**{numInvites}** meghívások)',
		hasPremiumInfo: true
	},
	joinMessageVanity: {
		type: 'String',
		grouping: [SettingsGroup.invites, SettingsGroup.joins],
		defaultValue: '{memberMention} **csatlakozott**; Vanity kód használatával **{inviteCode}**',
		hasPremiumInfo: true
	},
	joinMessageChannel: {
		type: 'Channel',
	...
	leaveMessage: {
		...
		defaultValue: '{memberName} **kilépett**; Meghívta **{inviterName}**',
		exampleValues: ['', ''],
		hasPremiumInfo: true
	},
	leaveMessageVanity: {
		type: 'String',
		grouping: [SettingsGroup.invites, SettingsGroup.leaves],
		defaultValue: '{memberName} **kilépett** miután {joinedAt:duration} csatlakozott óta a szerverhez.',
		hasPremiumInfo: true
	},
	leaveMessageChannel: {
		type: 'Channel',
	...
	rankAnnouncementMessage: {
		type: 'String',
		grouping: [SettingsGroup.invites, SettingsGroup.ranks],
		defaultValue: 'Gratulálunk, **{memberMention}** elérte a(z) **{rankName}** rangot!',
		exampleValues: ['', ''],
		hasPremiumInfo: true
	},
	...
	captchaVerificationWelcomeMessage: {
		...
		grouping: [SettingsGroup.moderation, SettingsGroup.captcha],
		defaultValue:
			'Üdvözöljük a szerveren **{serverName}**! Extra védelmi szint érdekében új tagoknak szükség van egy captcha beírására.',
		exampleValues: ['Üdvözöljük, kérjük beírja a captchát alá!'],
		hasPremiumInfo: true
	},
	captchaVerificationSuccessMessage: {
		type: 'String',
		grouping: [SettingsGroup.moderation, SettingsGroup.captcha],
		defaultValue: 'Sikeresen beírta a captchát. Üdvözöljük a szerveren!',
		exampleValues: ['Köszönjük, hogy beírta a captchát, élvezze a szerverünket!'],
		hasPremiumInfo: true
	},
	captchaVerificationFailedMessage: {
		...
		grouping: [SettingsGroup.moderation, SettingsGroup.captcha],
		defaultValue:
			'Nem sikerült beírni a captchát megfelelő idő alatt.' +
			`Sajnos, de kell kicsit kísérletezni. Vagyis, próbálja újra később.`,
		exampleValues: ['Hogyan lehetett volna ember? Előfordulhatnak hibák is. Próbálja újra később!'],
		hasPremiumInfo: true
	},
	...
	autoModDisabledForOldMembersThreshold: {
		...
		exampleValues: ['604800` (1 hét)`', '2419200` (1 hónap)`']
	},
