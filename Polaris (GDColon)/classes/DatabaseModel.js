...
.then(() => console.log(`Adatbázis csatlakoztatva! (${+process.uptime().toFixed(2)} secs)`))
.catch(e => { console.error('\x1b[40m\x1b[31m%s\x1b[0m', "!!! Hiba az adatbázishoz való csatlakozáskor !!!"); console.error(e) })
