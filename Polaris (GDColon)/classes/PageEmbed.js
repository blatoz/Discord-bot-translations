...
class PageEmbed {
    ...
    post(int, msgSettings={}) {
        ...
        let pageOptions = [
            {style: firstPage ? "Secondary" : "Success", label: `<< Oldal ${firstPage ? this.pages : Math.max((this.page - 1) || 1, 1)}`, customId: 'prev'},
            {style: lastPage ? "Secondary" : "Success", label: `Oldal ${lastPage ? 1 : Math.min((this.page + 1), this.pages)} >>`, customId: 'next'}
        ]
